...
![serialize-deserialize](media/serialize-deserialize.png)
...
![dubbo-keep-connection](media/dubbo-keep-connection.png)

而短连接，每次要发送请求之前，需要先重新建立一次连接。

![dubbo-not-keep-connection](media/dubbo-not-keep-connection.png)
...
[![dubbo-service-invoke-road](media/dubbo-service-invoke-road.png)](https://github.com/doocs/advanced-java/blob/master/images/dubbo-service-invoke-road.png)
